...
void ATP_ThirdPersonCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("LeftClick", IE_Pressed, this, &ATP_ThirdPersonCharacter::StartFire);
}
...
// GETTER SETTER
void ATP_ThirdPersonCharacter::SetCurrentHealth(float healthValue)
{
...
// properties update
void ATP_ThirdPersonCharacter::OnHealthUpdate()
{
...
float ATP_ThirdPersonCharacter::TakeDamage(float DamageTaken, struct FDamageEvent const& DamageEvent, AController* EventInstigator, AActor* DamageCauser)
{
...
void ATP_ThirdPersonCharacter::OnRep_CurrentHealth()
{
	OnHealthUpdate();
}
...
void ATP_ThirdPersonCharacter::StartFire()
{
	if (!bIsFiringWeapon)
	{
		bIsFiringWeapon = true;
		UWorld* World = GetWorld();
		World->GetTimerManager().SetTimer(FiringTimer, this, &ATP_ThirdPersonCharacter::StopFire, FireRate, false);
		HandleFire(); // RPC 调用
	}
}
...
void ATP_ThirdPersonCharacter::HandleFire_Implementation()
{
